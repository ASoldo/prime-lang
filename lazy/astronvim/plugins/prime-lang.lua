return {
	...
	},
	{
		...
		opts = function(_, opts)
			...
			do
				local highlights = [[
    ["fn" "let" "mut" "import" "struct" "enum" "const" "match" "if" "else" "for" "in" "while" "loop" "spawn" "return" "break" "continue" "defer" "module" "test" "library" "pub" "interface" "impl" "try" "move"] @keyword
